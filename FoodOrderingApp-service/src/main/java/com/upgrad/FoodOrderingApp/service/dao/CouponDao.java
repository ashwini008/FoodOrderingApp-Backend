...
public class CouponDao {
    ...
    public CouponEntity getCouponByCouponId(String couponUiid) {
        try {
            CouponEntity couponEntity = entityManager.createNamedQuery("getCouponByCouponId",CouponEntity.class).setParameter("uuid",couponUiid).getSingleResult();
            return couponEntity;
        }catch (NoResultException nre) {
            return null;
        }
