...
public class RestaurantController {
    ...
    @Autowired
    private CustomerService customerService;  // Handles all the Service Related to Customer.
    ...
    */
    ...
    public ResponseEntity<RestaurantListResponse> getAllRestaurants() {
        ...
        for (RestaurantEntity restaurantEntity : listOfRestaurants) { //Looping for each restaurant entity in restaurantEntities
            ...
            responseAddress.setFlatBuildingName(restaurantEntity.getAddress().getFlatBuilNo());
    ...
    public ResponseEntity<RestaurantDetailsResponse> getRestaurantByRestaurantID(
        ...
        for (CategoryEntity categoryEntity : categoryEntities) {
            ...
            itemEntities.forEach(itemEntity -> {
                 String itemType = itemEntity.getType().equals("0") ? ItemType.VEG : ItemType.NON_VEG;
                ItemList itemList = new ItemList().id(UUID.fromString(itemEntity.getUuid()))
                        ...
                        .itemType(ItemList.ItemTypeEnum.fromValue(itemType));
